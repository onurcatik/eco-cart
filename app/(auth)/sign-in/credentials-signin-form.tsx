...
//   // Şifre sıfırlama işlemi için state
...
//       {/* Left: Image */}
//       <div className="hidden object-fill lg:w-[1500px] lg:h-screen lg:block xl:w-screen">
//         <Image
...
//               Forgot Password?
//             </button>
//             {resetMessage && <p className='text-red-500 text-sm mt-1'>{resetMessage}</p>}
//           </div>
